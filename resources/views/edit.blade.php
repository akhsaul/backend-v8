    ...
    <div class="content-wrapper">
        ...
        <div class="container" style="margin-right: 2px;">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h3 class="text-center text-danger"><b>Update Data {{$posts->category}}</b>
                    </h3>
                    <div class="form-group">
                        <form action="/update/{{ $posts->id }}" method="post" enctype="multipart/form-data">
                            ...
                            <label for="image" style="float: end">File Gambar
                                <input type="file" id="input-file-now-custom-3 image" class="form-control m-2"
                                       name="image"
                                       required
                                       aria-required="true">
                            </label>
                            ...
                            <label for="sound">File Suara
                                <input type="file" id="input-file-now-custom-3 sound" class="form-control m-2"
                                       name="sound"
                                       required
                                       aria-required="true">
                            </label>
